...
straight_1_segs = [(straight_1[0][0], straight_1[0][1], bearing_1)]
for frame in range(straight_1_seg_count):
    lat_prev, lon_prev, _ = straight_1_segs[-1]
    lon_next, lat_next, _ = geodesic.fwd(lon_prev, lat_prev, bearing_1, seg_dist)
    straight_1_segs.append((lat_next, lon_next, bearing_1))
...
straight_2_segs = [(straight_2[0][0], straight_2[0][1], bearing_2)]
for frame in range(straight_2_seg_count):
    lat_prev, lon_prev, _ = straight_2_segs[-1]
    lon_next, lat_next, _ = geodesic.fwd(lon_prev, lat_prev, bearing_2, seg_dist)
    straight_2_segs.append((lat_next, lon_next, bearing_2))
