...
parser.add_argument('--r_lookahead', type=int, default=2)
...
if __name__ == '__main__':
    ...
    class cacc_aplf(roscontrol):
        ...
        def should_listen(self, sender_number):
            """Overriding the default APLF network topology to implement r-lookahead"""
            return sender_number > (self.args.car_number - self.args.r_lookahead) and sender_number < self.args.car_number
